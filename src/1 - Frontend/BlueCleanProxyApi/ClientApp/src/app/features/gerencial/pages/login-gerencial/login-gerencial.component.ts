...
@Component({
  selector: 'app-login-gerencial',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [ReactiveFormsModule],
  templateUrl: './login-gerencial.component.html',
  styleUrls: ['./login-gerencial.component.scss']
})
export class LoginGerencialComponent {
  ...
  protected readonly tipoLogin = TipoLogin.Gerencial;
    ...
    this.loginService
      ...
      .subscribe({
        next: (response) => {
          ...
          this.router.navigateByUrl('/gerencial');
        },
