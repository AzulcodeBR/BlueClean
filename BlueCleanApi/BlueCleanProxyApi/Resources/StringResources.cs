...
public class StringResources
{
  ...
  public const string LoginErroComunicacaoBackend = "Erro ao comunicar com a API de backend.";
  public const string CepErroComunicacaoBackend = "Erro ao comunicar com a API de backend.";
}
